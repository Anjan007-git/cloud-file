...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 bg-gradient-sidebar text-sidebar-foreground p-5 gap-6 sticky top-0 h-screen">
      ...
      <div className="px-1">
        ...
        <button className="mt-4 w-full rounded-xl bg-white/12 hover:bg-white/20 text-white text-sm font-semibold py-2.5 transition-colors">
          Upgrade Storage
        </button>
      </div>
      ...
      <div className="mt-auto flex flex-col gap-1">
        ...
        <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-white/70 hover:bg-white/10 hover:text-white transition-colors">
